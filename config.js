...
module.exports = {
    ...
    TERRORBOY: process.env.TAG_REPLY === undefined ? '94761905764@s.whatsapp.net' : process.env.TAG_REPLY,
    LIYANAME: process.env.LIYA_NAME === undefined ? 'ZARA MWOL' : process.env.LIYA_NAME,
    SAIDNUMBER: process.env.SAID_NUMBER=== undefined ? '94761905764' : process.env.SAID_NUMBER,
    ...
    YAK: process.env.YAK === undefined ? '94761905764,0' : process.env.YAK,
